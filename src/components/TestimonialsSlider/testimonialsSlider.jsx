        ...
        <div className="glide">
          ...
          <div className="flex flex-row items-center justify-center pt-5">
            <div className="glide__arrows" data-glide-el="controls">
              <button className="glide__arrow glide__arrow--left bg-white text-emerald-600 font-bold py-2 px-6 rounded-full hover:text-white hover:bg-emerald-600 border-emerald-700" data-glide-dir="<">
                Prev
              </button>
            </div>
            <div className="glide__arrows" data-glide-el="controls">
              <button className="glide__arrow glide__arrow--right bg-white text-emerald-600 font-bold py-2 px-6 rounded-full mr-4 hover:text-white hover:bg-emerald-600 border-emerald-700" data-glide-dir=">">
                Next
              </button>
            </div>
          </div>
